...
// playready 
    KeyedVector<unsigned, Vector<MfraEntry> > mMfraEntries;
    Vector<MfraEntry> mMfraEntry;        // used for not mfra box, only for null argv
    bool mIsPlayReady;	
    uint64_t mHeaderDurationUs; // file duration
//
