...
struct NuPlayer::Renderer : public AHandler {
    ...
    void changeAudio();//for ALPS01940787
#endif
...
//#endif 
...
#if defined(MTK_AOSP_ENHANCEMENT) && defined(MTK_AUDIO_CHANGE_SUPPORT) 
    bool mVideoEOS;
    bool mNoJudgeWhenChangeAudio;//for ALPS01940787
#endif
    bool mAudioFlushed;
    bool mUseSyncQueues;
    bool mUseFlushAudioSyncQueues;
	bool mRetryOffload;
	int64_t mPausedTimeUsOffload;
	...
	void notifyRetryAudioOffload();
	void onRetryAudioOffload();
#endif
